<template>
    <div class="flex justify-center align-center flex-col items-center">
        <img
            src="https://sed-stan-personal-site.s3.amazonaws.com/images/laptop-stickers-1920.webp"
        ...
        <div class="container absolute font-titillium text-oldLace pb-12">
            <img
                ...
                src="https://sed-stan-personal-site.s3.amazonaws.com/images/head-shot-transparent.webp"
                alt="A headshot of a man."
                width="160"
                height="160"
            />
