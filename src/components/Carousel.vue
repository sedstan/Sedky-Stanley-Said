            ...
            <app-link isExternal :to="`${repo.node.url}`">
                <article
                    ...
                    <div class="align-left">
                        <div class="mb-4 border-b border-barnRed w-full group-hover:border-cultured">
                            <h3
                                class="text-3xl md:2xl sm:xl font-titillium text-barnRed pb-2 group-hover:text-cultured">
                                {{ repo.node.name }}
                            </h3>
                        </div>
                        <p class="font-roboto text-bistro mb-4 group-hover:text-cultured">
                        ...
                        <div class="group-hover:hidden mb-3">
                            ...
                            <p v-for="language in repo.node.languages.edges" :key="language.node"
